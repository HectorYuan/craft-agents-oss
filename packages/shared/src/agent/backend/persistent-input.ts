/**
 * Pushable async-iterable input stream for the generic streaming-input mode (ex-Claude SDK).
 *
 ...
 */
/**
 * Single source of truth for the WS2 keep-alive flag, so backends and
