 ...
 *
 * Watched paths:
 * - ~/.zenskill/config.json - Main app configuration
 * - ~/.zenskill/preferences.json - User preferences
 * - ~/.zenskill/theme.json - App-level theme overrides
 * - ~/.zenskill/themes/*.json - Preset theme files (app-level)
 * - ~/.zenskill/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.zenskill/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.zenskill/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.zenskill/permissions/)
