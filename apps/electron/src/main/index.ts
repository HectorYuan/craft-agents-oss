...
const DEEPLINK_SCHEME = process.env.CRAFT_DEEPLINK_SCHEME || 'zenskill'
...
// Supports multi-instance dev: CRAFT_APP_NAME env var (e.g., "ZenSkill [1]")
app.setName(process.env.CRAFT_APP_NAME || 'ZenSkill')
