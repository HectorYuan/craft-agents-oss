...
import { TiptapMarkdownEditor } from '@craft-agent/ui/markdown/TiptapMarkdownEditor'
...
const events: PlannerTaskEvent[] = [
  ...
  { id: 'e4', taskId: 't1', type: 'task.session_snapshot_updated', at: 'Today · 18:42', actor: 'ZenSkill', payloadSummary: 'Refreshed snapshot summary' },
]
