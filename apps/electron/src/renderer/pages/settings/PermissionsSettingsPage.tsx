 ...
 * Shows both default patterns (from ~/.zenskill/desktop/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.zenskill/desktop/permissions/default.json.
...
/**
 * Build default permissions data from ~/.zenskill/desktop/permissions/default.json.
