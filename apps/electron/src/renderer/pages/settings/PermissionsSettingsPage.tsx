 ...
 * Shows both default patterns (from ~/.zenskill/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.zenskill/permissions/default.json.
...
/**
 * Build default permissions data from ~/.zenskill/permissions/default.json.
