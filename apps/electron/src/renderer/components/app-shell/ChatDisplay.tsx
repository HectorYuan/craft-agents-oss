...
export const ChatDisplay = React.forwardRef<ChatDisplayHandle, ChatDisplayProps>(function ChatDisplay({
  ...
  // These settings are stored in ~/.zenskill/desktop/preferences.json (not localStorage)
                    ...
                    return (
                      ...
                      <TurnCard
                        ...
                        renderToolResultCard={(activity) => {
                          ...
                          return <GtdToolResultCard toolName={activity.toolName} resultText={activity.content} workspaceId={session.workspaceId} sourceSlug={ZENSKILL_SOURCE_SLUG} />
                        }}
