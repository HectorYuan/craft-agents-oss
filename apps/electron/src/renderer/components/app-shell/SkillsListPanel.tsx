...
import { ZenSkillMarketSearch } from '@/components/zenskill/ZenSkillMarketSearch'
...
export function SkillsListPanel({
  ...
  return (
    <>
    {/* ZenSkill mount point (L0): marketplace search + install */}
    <ZenSkillMarketSearch workspaceId={workspaceId} />
      ...
      mapItem={(skill) => ({
        ...
        menu: (
          <SkillMenu
            ...
            onOpenInNewWindow={() => window.electronAPI.openUrl(`zenskill://skills/skill/${skill.slug}?window=focused`)}
