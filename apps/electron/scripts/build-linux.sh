...
echo "=== Building ZenSkill AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: ZenSkill-x86_64.AppImage or ZenSkill-aarch64.AppImage
BUILT_APPIMAGE_NAME="ZenSkill-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: ZenSkill-x64.AppImage, ZenSkill-arm64.AppImage
APPIMAGE_NAME="ZenSkill-${ARCH}.AppImage"
